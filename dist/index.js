...
const main = () =>
    __awaiter(void 0, void 0, void 0, function* () {
        ...
        const nOnesOoutput = document.querySelector('#binary-demo .ones');
        ...
        const iterationNOnesOoutput = document.querySelector('#iteration .ones');
        const interationStepsInput = document.querySelector('#iteration input[type="range"]');
        if (
        ...
        const decreaseNOnesOoutput = document.querySelector('#decrease-demo .ones');
